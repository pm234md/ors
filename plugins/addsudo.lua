...
local user = 196780042 -- اینجا شناسه عددی خودتان را قرار بدید
...
if is_owner(msg) then
    if msg.from.username ~= nil then
      if string.find(msg.from.username , 'Dr_Root') then --اینجا دقیقا یوزرنیم خود را بدون @ قرار بدید(به حروف بزرگ و کوچک یوزرنیم خود دقت کنید)
